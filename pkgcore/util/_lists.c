...
pkgcore_iter_flatten_instance_init(pkgcore_iter_flatten_instance *self,
								   PyObject *args, PyObject *kwargs)
{
	PyObject *l=NULL, *skip_flattening=NULL;
	PyObject *tmp, *iter, *iters;
...
static struct PyMethodDef pkgcore_lists_methods[] = {
	{"iter_flatten", (PyCFunction)pkgcore_iter_flatten,
	 METH_VARARGS|METH_KEYWORDS, "iter_flatten stuff"
    },
...
static char pkgcore_lists_documentation[] =
