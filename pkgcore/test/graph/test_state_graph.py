...
from pkgcore.restrictions.packages import package_type
from pkgcore.ebuild.conditionals import DepSet
from pkgcore.graph.state_graph import combinations
if not hasattr(__builtins__, "set"):
	from sets import Set as set

class StrPackage(StrExactMatch):
	"""simple string restriction for testing purposes (pkgcore.package.atom requires
